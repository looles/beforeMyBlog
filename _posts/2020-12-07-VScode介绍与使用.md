---
title: Vscode介绍与常见使用配置
description: vscode的使用教程与常见配置
tags:
  - 常用软件
  - vscode
categories: 常用软件
abbrlink: 1005bb8
date: 2020-12-07 10:04:00
---
...
![image-20201207100741400](https://gitee.com/happyzm/images/raw/master/image-20201207100741400.png)
...
![image-20201207100857525](https://gitee.com/happyzm/images/raw/master/image-20201207100857525.png)

上图中，在展开的菜单中选择「键盘快捷方式」，就可以查看和修改所有的快捷键列表了：

![image-20201207100925800](https://gitee.com/happyzm/images/raw/master/image-20201207100925800.png)
...
![image-20201207101129526](https://gitee.com/happyzm/images/raw/master/image-20201207101129526.png)
...
![image-20201207101145690](https://gitee.com/happyzm/images/raw/master/image-20201207101145690.png)
...
![image-20201207101158210](https://gitee.com/happyzm/images/raw/master/image-20201207101158210.png)

### 4、使用命令行启动 VS Code

（1）输入快捷键「Cmd + Shift + P 」，选择`install code command`：

![image-20201207101208383](https://gitee.com/happyzm/images/raw/master/image-20201207101208383.png)
...
![image-20201207101224277](https://gitee.com/happyzm/images/raw/master/image-20201207101224277.png)

上图中，将红框部分打钩即可。

设置成功后，我们就可以查看到当前文件的「层级结构」，非常方便。如下图所示：

![image-20201207101235894](https://gitee.com/happyzm/images/raw/master/image-20201207101235894.png)
...
![image-20201207101259462](https://gitee.com/happyzm/images/raw/master/image-20201207101259462.png)
...
![image-20201207101310831](https://gitee.com/happyzm/images/raw/master/image-20201207101310831.png)
...
![image-20201207101322453](https://gitee.com/happyzm/images/raw/master/image-20201207101322453.png)
...
![image-20201207101335497](https://gitee.com/happyzm/images/raw/master/image-20201207101335497.png)
...
![image-20201207101346332](https://gitee.com/happyzm/images/raw/master/image-20201207101346332.png)
...
![image-20201207101358905](https://gitee.com/happyzm/images/raw/master/image-20201207101358905.png)

- **editor.insertSpaces**：按 Tab 键时插入空格（默认）。截图如下：

![image-20201207101409185](https://gitee.com/happyzm/images/raw/master/image-20201207101409185.png)

- **editor.tabSize**：一个制表符默认等于四个空格。截图如下：

![image-20201207101438730](https://gitee.com/happyzm/images/raw/master/image-20201207101438730.png)
...
![image-20201207101450594](https://gitee.com/happyzm/images/raw/master/image-20201207101450594.png)
...
![image-20201207101505210](https://gitee.com/happyzm/images/raw/master/image-20201207101505210.png)
...
![image-20201207101522643](https://gitee.com/happyzm/images/raw/master/image-20201207101522643.png)

VS Code 自带的对比功能并不够强大，我们可以安装插件`compareit`，进行更丰富的对比。比如说，安装完插件`compareit`之后，我们可以将「当前文件」与「剪切板」里的内容进行对比：

![image-20201207101542594](https://gitee.com/happyzm/images/raw/master/image-20201207101542594.png)
...
![image-20201207101554810](https://gitee.com/happyzm/images/raw/master/image-20201207101554810.png)
...
![image-20201207101604795](https://gitee.com/happyzm/images/raw/master/image-20201207101604795.png)
...
![image-20201207101616331](https://gitee.com/happyzm/images/raw/master/image-20201207101616331.png)
...
![image-20201207101626916](https://gitee.com/happyzm/images/raw/master/image-20201207101626916.png)
...
![image-20201207101640084](https://gitee.com/happyzm/images/raw/master/image-20201207101640084.png)

那么，就可以创建多层子文件夹，效果如下：

![image-20201207101655883](https://gitee.com/happyzm/images/raw/master/image-20201207101655883.png)
...
![image-20201207101708122](https://gitee.com/happyzm/images/raw/master/image-20201207101708122.png)
...
![image-20201207101805203](https://gitee.com/happyzm/images/raw/master/image-20201207101805203.png)

上图中，我们点击最新的那条记录，就可将云端的最新配置同步到本地：

![image-20201207101815779](https://gitee.com/happyzm/images/raw/master/image-20201207101815779.png)
...
![image-20201207101846905](https://gitee.com/happyzm/images/raw/master/image-20201207101846905.png)
...
![image-20201207101903644](https://gitee.com/happyzm/images/raw/master/image-20201207101903644.png)
...
![image-20201207101953154](https://gitee.com/happyzm/images/raw/master/image-20201207101953154.png)
...
![image-20201207102019401](https://gitee.com/happyzm/images/raw/master/image-20201207102019401.png)
...
![image-20201207102044195](https://gitee.com/happyzm/images/raw/master/image-20201207102044195.png)
...
![image-20201207102056680](https://gitee.com/happyzm/images/raw/master/image-20201207102056680.png)

上图中，点击红框部分，登录后就可以分享你的工作空间了。

![image-20201207102106737](https://gitee.com/happyzm/images/raw/master/image-20201207102106737.png)
